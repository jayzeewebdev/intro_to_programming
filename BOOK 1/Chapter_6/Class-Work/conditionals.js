...
if (name.length > 2) {  // Check if the length of the 'name' string is greater than 7 characters
...
var lemonChicken = true;      // Lemon chicken is not available
var beefWithBlackBean = false;  // Beef with black bean is available
var sweetAndSourPork = false;  // Sweet and sour pork is available
